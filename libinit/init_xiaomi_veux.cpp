...
static const variant_info_t veux_in_info = {
    ...
    .model = "2201116SG",
    .name = "veux_in",
    .build_fingerprint = "Redmi/veux_in/veux:12/SKQ1.211006.001/V13.0.5.0.SKCINXM:user/release-keys",
};
...
static const variant_info_t veux_info = {
    ...
    .model = "2201116SC",
    .name = "veux",
    .build_fingerprint = "Redmi/veux/veux:12/SKQ1.211006.001/V13.0.5.0.SKCCNXM:user/release-keys",
...
static const variant_info_t peux_in_info = {
    ...
    .model = "2201116SI",
    .name = "peux_in",
    .build_fingerprint = "Redmi/peux_in/peux:12/SKQ1.211006.001/V13.0.5.0.SKCINXM:user/release-keys",
};
...
static const variant_info_t veux_jp_info = {
    ...
    .model = "2201116SR",
    .name = "veux_jp",
    .build_fingerprint = "Redmi/veux_jp/veux:11/SKQ1.211006.001/V13.0.5.0.SKCJPXM:user/release-keys",
...
static const variant_info_t veux_p_in_info = {
    ...
    .model = "2201116PG",
    .name = "veux_p_in",
    .build_fingerprint = "POCO/veux_p_in/veux:12/SKQ1.211006.001/V13.0.5.0.SKCINXM:user/release-keys",
};
...
static const variant_info_t peux_p_in_info = {
    ...
    .model = "2201116PI",
    .name = "peux_p_in",
    .build_fingerprint = "POCO/peux_p_in/peux:12/SKQ1.211006.001/V13.0.5.0.SKCINXM:user/release-keys",
};
